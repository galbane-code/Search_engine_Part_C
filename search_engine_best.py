...
from searcher import Searcher, WordNet_Searcher, Mix_Searcher
...
class SearchEngine:
    ...
    def __init__(self, config=None):
        ...
        self._model = Mix_Searcher(self._indexer)
...
#             break
#
#         with open('Mix.csv', 'w', newline='') as file:
...
#         our_results = pd.read_csv("Mix.csv")
...
#
#         our_results.to_csv("Mix.csv", index=False)
#
#
# def main():
